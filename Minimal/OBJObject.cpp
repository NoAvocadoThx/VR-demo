...
OBJObject::OBJObject(const char *filepath)
{
	...
	glBufferData(GL_ARRAY_BUFFER, a_vertices.size() * sizeof(glm::vec3), &a_vertices[0], GL_STATIC_DRAW);
	...
	glBufferData(GL_ARRAY_BUFFER, a_normals.size() * sizeof(glm::vec3), &a_normals[0], GL_STATIC_DRAW);
